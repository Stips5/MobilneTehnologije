...
import hr.stips.mobilnetehnologije.Vjezbe.Zadatak9.Zadatak9_NewActivity;
...
public class RvAdapter extends RecyclerView.Adapter<RvAdapter.RvViewHolder> {
    ...
    @Override
    public void onBindViewHolder(RvViewHolder holder, int position) {//stavljanje podataka na view holder
